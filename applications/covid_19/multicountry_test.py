...
from applications.covid_19.JH_data.process_JH_data import get_all_jh_countries, read_john_hopkins_data_from_csv
...
for i, country in enumerate(intercept_country_list):
    print("################")
    print(country + " // i=" + str(i))
    data = read_john_hopkins_data_from_csv(country=country)
    print(sum(data))
