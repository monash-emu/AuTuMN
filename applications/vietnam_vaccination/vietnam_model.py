...
end_time = 2500.0
time_step = 1
my_times = numpy.linspace(
    start_time, end_time, int((end_time - start_time) / time_step) + 1
).tolist()

# Set up compartments
my_compartments = ["susceptible", "early_latent", "late_latent", "infectious", "recovered"]
...
my_flows = [
    ...
    {
        "type": "standard_flows",
        "parameter": "rapid_progression_rate",
        "origin": "early_latent",
        "to": "infectious",
    },
    {
        "type": "standard_flows",
        "parameter": "immune_stabilisation_rate",
        "origin": "early_latent",
        "to": "late_latent",
    },
    {
        "type": "standard_flows",
        "parameter": "reactivation_rate",
        "origin": "late_latent",
        "to": "infectious",
    },
    {
...
if cdr:
    ...
    treatment_rate = (
        case_detection
        * (self_recovery_rate + tb_mortality_rate + universal_death_rate)
        / (1.0 - case_detection)
    )
...
if "age" in stratify_by:
    ...
    immune_stabilisation_adjustment = {
        "0W": 1.2e-2 * 365.25,
        "5W": 1.2e-2 * 365.25,
        "10W": 1.2e-2 * 365.25,
    }
    reactivation_rate_adjustment = {
        "0W": 1.9e-11 * 365.25,
        "5W": 6.4e-6 * 365.25,
        "10W": 6.4e-6 * 365.25,
    }
    rapid_progression_rate_adjustment = {
        "0W": 6.6e-3 * 365.25,
        "5W": 2.7e-3 * 365.25,
        "10W": 2.7e-3 * 365.25,
    }
    ...
    my_model.stratify(
        ...
        adjustment_requests={
            "immune_stabilisation_rate": immune_stabilisation_adjustment,
...
if "bcg" in stratify_by:
    ...
    my_model.stratify(
        ...
        verbose=False,
        adjustment_requests={
            "infection_rateXage_0": {"bcg_vaccinated": 0.2},
...
if "novel" in stratify_by:
    ...
    my_model.stratify(
        ...
        verbose=False,
        adjustment_requests={
            "infection_rateXage_10": {"novel_vaccinated": 0.5},
...
def create_outputs(
    ...
    for scenario_index in range(len(models)):
        ...
        my_post_proccessing_list.append(
