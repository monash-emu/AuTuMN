...
PAR_PRIORS = [
    {'param_name': 'contact_rate', 'distribution': 'uniform', 'distri_params': [0.015, 0.035]},
    {'param_name': 'start_time', 'distribution': 'uniform', 'distri_params': [0., 50]},
]
...
if __name__ == "__main__":
    run_mys_calibration_chain(30, 0)
