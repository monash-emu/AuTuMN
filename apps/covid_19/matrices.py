...
def update_mixing_parameters_for_prayers(
    mixing_params, t_start, participating_prop, other_location_multiplier, t_end=365
):
    """
    ...
    amplified_val = reference_val * (
        (1.0 - participating_prop) + other_location_multiplier * participating_prop
    )
    while t < t_end:
