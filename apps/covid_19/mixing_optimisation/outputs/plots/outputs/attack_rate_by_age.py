...
FIGURE_PATH = os.path.join(BASE_PATH, "apps", "covid_19", "mixing_optimisation",
                           "outputs", "plots", "outputs", "figures", "attack_rate_by_age")
...
def plot_attack_rates_by_age(all_derived_outputs, country, mode, duration, objective, ax):
    ...
    for age_index in range(16):
        ...
        perc_reco = 100 * list(derived_outputs[f"proportion_seropositiveX{age_group_name}"])[time_index]
    ...
    for j, duration in enumerate(DURATIONS):
        for h, objective in enumerate(OBJECTIVES):
            ...
            for i, country in enumerate(countries):
                ...
                plot_attack_rates_by_age(all_derived_outputs, country, mode, duration, objective, ax)
