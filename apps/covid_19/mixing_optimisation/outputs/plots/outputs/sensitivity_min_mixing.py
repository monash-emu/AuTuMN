...
FIGURE_PATH = os.path.join(BASE_PATH, "apps", "covid_19", "mixing_optimisation",
                           "outputs", "plots", "outputs", "figures", "sensitivity_min_mixing")
    ...
    for i, country in enumerate(countries):
        ...
        for j, duration in enumerate(DURATIONS):
            ...
            if i == 0:
                ...
                ax.text(0.5, 0.5, duration_titles[j], fontsize=text_size, horizontalalignment='center', verticalalignment='center')
                ax.axis("off")
