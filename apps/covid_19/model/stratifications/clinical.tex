...
\begin{figure}[h]
    \includegraphics[width=\textwidth]{../model/stratifications/covid_19_clinical_strat.pdf}
...
\begin{figure}[h]
    \includegraphics[width=\textwidth]{../model/stratifications/covid_19_clinical_rationale.pdf}
...
\renewcommand{\baselinestretch}{1}
    \begin{tabular}{|p{1.5cm}|p{4.2cm}|p{2.4cm}|c|c|}
        \hline
