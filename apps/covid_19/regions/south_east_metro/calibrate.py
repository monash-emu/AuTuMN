...
TARGET_OUTPUTS = add_standard_victoria_targets([], targets, Region.SOUTH_EAST_METRO)

PAR_PRIORS = provide_default_calibration_params(("time.start", "contact_rate"))
PAR_PRIORS = add_standard_victoria_params(PAR_PRIORS, Region.SOUTH_EAST_METRO)
