from apps.covid_19.vaccine_optimisation.constants import (
    SCENARIO_START_TIME, PHASE_2_DURATION, PHASE_3_DURATION, SEVERITY_EFFICACY, INFECTION_EFFICACY, TOTAL_DAILY_DOSES,
    VACC_AGE_GROUPS
)
...
def get_vacc_roll_out_func(decision_vars, country):
    ...
    for i_age_group, age_group in enumerate(VACC_AGE_GROUPS):
        ...
        component = {
            "age_min": age_group[0],
            "supply_timeseries": {
                "times": [SCENARIO_START_TIME - 1, SCENARIO_START_TIME, PHASE_2_END, PHASE_2_END + 1],
                "values": [0., daily_doses_phase_2, daily_doses_phase_2, daily_doses_phase_3]
            }
        }
