from apps.tuberculosis_strains.constants import Compartment, OrganStratum
from apps.tuberculosis_strains.model.preprocess.latency import get_adapted_age_parameters, edit_adjustments_for_diabetes
