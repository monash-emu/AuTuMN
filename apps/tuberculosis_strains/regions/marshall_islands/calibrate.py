...
from apps.tuberculosis_strains.calibration_utils import get_latency_priors_from_epidemics, get_natural_history_priors_from_cid

targets = load_targets("tuberculosis_strains", Region.MARSHALL_ISLANDS)


def run_calibration_chain(max_seconds: int, run_id: int, num_chains: int):
    params = load_params("tuberculosis_strains", Region.MARSHALL_ISLANDS)
    calib = Calibration(
