...
from autumn.core.inputs.covid_phl.queries import \
    get_phl_subregion_testing_numbers
...
from autumn.core.inputs.demography.queries import (
    get_crude_birth_rate, get_death_rates_by_agegroup,
    get_iso3_from_country_name, get_life_expectancy_by_agegroup,
