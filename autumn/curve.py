            ...
            def cut_off(indice, bound_low, bound_up, sign):
                ...
                while go == 1:
                    ...
                    if (indice + k) == 0:
                        ...
                        y_k = a_f[0] + a_f[1] * x[indice + k] + a_f[2] * x[indice + k] ** 2 + a_f[3] * x[
                                                                                                           indice + k] ** 3
                ...
                if t1 == 0:  # there is something wrong here
                    spare = get_spare_fit(indice, x_peak, bound, 'left', f, cut_off_dict, bound_low, bound_up, a_init,
                                          a_f, x, y)
                    a1 = spare['a']
                ...
                if t2 == 0:  # there is something wrong here
                    spare = get_spare_fit(indice, x_peak, bound, 'right', f, cut_off_dict, bound_low, bound_up, a_init,
                                          a_f, x, y)
                    a2 = spare['a']
