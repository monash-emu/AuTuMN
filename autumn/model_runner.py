    ...
    def run_epi_uncertainty(self):
        ...
        while run < self.gui_inputs['uncertainty_runs']:
            ...
            if self.is_last_run_success:
                ...
                # get outputs for calibration and store results (regardless of acceptance, provided run was successful)
                ...
                if accepted:
                    ...
                    # run scenarios - only if accepted and not for baseline (which is zero and so evaluates as False)
                ...
                self.add_comment_to_gui_window('{} accepted / {} candidates. Running time: {}'.format(
