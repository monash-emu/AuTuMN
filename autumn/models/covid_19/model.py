...
def build_model(params: dict, build_options: dict = None) -> CompartmentalModel:
    ...
    voc_ifr_effect = {"wild": 1.}
    voc_hosp_effect = {"wild": 1.}
    if params.voc_emergence:
        ...
        voc_ifr_effect.update({s: params.voc_emergence[s].ifr_multiplier for s in strain_strat.strata[1:]})
        voc_hosp_effect.update({s: params.voc_emergence[s].hosp_multiplier for s in strain_strat.strata[1:]})
    ...
    clinical_strat = get_clinical_strat(params, voc_ifr_effect, voc_hosp_effect)
    ...
    if vacc_params:
        ...
        vaccination_strat = get_vaccination_strat(params, vacc_strata, voc_ifr_effect, voc_hosp_effect)
    ...
    if is_waning_immunity:
        history_strat = get_history_strat(params, voc_ifr_effect, voc_hosp_effect)
