...
from .strat_processing.vaccination import (
    add_requested_vacc_flows, add_vic_regional_vacc, add_vic2021_supermodel_vacc, add_lka_vacc
)
...
def build_model(params: dict, build_options: dict = None) -> CompartmentalModel:
    ...
    if vacc_params:
        ...
        if params.vic_status == VicModelTypes.VIC_SUPER_2021:
            ...
            add_lka_vacc(model, vacc_params, params.time.start, params.time.end)
        else:
