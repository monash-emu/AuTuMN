...
def get_agegroup_strat(
    ...
    age_strat = Stratification("agegroup", COVID_BASE_AGEGROUPS, COMPARTMENTS)
    ...
    age_split_props = {agegroup: prop for agegroup, prop in zip(COVID_BASE_AGEGROUPS, pop_proportions)}
