...
def get_history_strat(
        params: Parameters, voc_ifr_effect: Dict[str, float], voc_hosp_effect: Dict[str, float]
) -> Stratification:
    """
    ...
    for voc in voc_ifr_effect.keys():
        ...
        ifr_adjuster_experienced *= voc_ifr_effect[voc]
    ...
    add_clinical_adjustments_to_strat(history_strat, flow_adjs, History.NAIVE, voc_ifr_effect)
