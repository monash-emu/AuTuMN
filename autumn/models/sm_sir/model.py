...
def build_model(
    ...
    vacc_region_available = ["Metro Manila", "Hanoi", "Ho Chi Minh City", None, "BARMM", "Western Visayas"]
    ...
    if is_dynamic_immunity:
        ...
        if iso3 == "PHL" or iso3 == "VNM":
            apply_reported_vacc_coverage_with_booster(
                ...
                current_daily_rates=params.current_daily_rates,
                latest_vacc_coverage=params.latest_vacc_coverage
            )
        else:
            apply_reported_vacc_coverage(
                compartment_types,
