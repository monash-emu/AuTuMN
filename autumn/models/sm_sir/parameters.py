...
class Parameters:
    ...
    # FIXME: this should be done using lists
    rp_noise_sd: Optional[float]
    rp_coeff_1: Optional[float]
    rp_coeff_2: Optional[float]
    rp_value_0: Optional[float]
    rp_value_1: Optional[float]
    rp_value_2: Optional[float]
    rp_value_3: Optional[float]
    rp_value_4: Optional[float]
    rp_value_5: Optional[float]
    rp_value_6: Optional[float]
    rp_value_7: Optional[float]
    rp_value_8: Optional[float]
    rp_value_9: Optional[float]
    rp_value_10: Optional[float]
    rp_value_11: Optional[float]
    rp_value_12: Optional[float]
    rp_value_13: Optional[float]
    rp_value_14: Optional[float]
    rp_value_15: Optional[float]
    rp_value_16: Optional[float]
    rp_value_17: Optional[float]
    rp_value_18: Optional[float]
    rp_value_19: Optional[float]
    rp_value_20: Optional[float]
