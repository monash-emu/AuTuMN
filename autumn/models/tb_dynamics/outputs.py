...
def request_outputs(
    ...
    # Death
    output_builder.request_flow_output("mortality_infectious_raw", "infect_death", save_results=False)
    output_builder.request_flow_output("mortality_on_treatment_raw", "treatment_death", save_results=False)
    sources = ["mortality_infectious_raw", "mortality_on_treatment_raw"]
    output_builder.request_aggregation_output("mortality_raw", sources, save_results=False)
    model.request_cumulative_output(
      ...
      # Disease incidence
    output_builder.request_flow_output("incidence_early_raw", "early_activation", save_results=False)
    ...
    output_builder.request_normalise_flow_output("incidence_norm", "incidence_raw", save_results=False)
