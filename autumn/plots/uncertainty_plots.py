...
def plot_timeseries_with_uncertainty(path_to_percentile_outputs: str, output_names: List[str], scenario_list=[0],
                                     burn_in=0):
    ...
    for output_name in output_names:
        plots.plot_timeseries_with_uncertainty(plotter, path_to_percentile_outputs, output_name, scenario_list,
                                               burn_in=burn_in)


if __name__ == '__main__':
    plot_timeseries_with_uncertainty('../../data/covid_malaysia/calibration-covid_malaysia-fake-18-05-2020',
