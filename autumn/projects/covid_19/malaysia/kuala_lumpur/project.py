...
priors = [
    ...
    *get_dispersion_priors_for_gaussian_targets(targets),
    ...
    # Microdistancing
    UniformPrior("mobility.microdistancing.behaviour.parameters.upper_asymptote", [0.2, 0.8]),
    ...
    UniformPrior("clinical_stratification.props.symptomatic.multiplier", [0.7, 2.2]),
