...
priors = [
    ...
    *get_dispersion_priors_for_gaussian_targets(targets),
    ...
    UniformPrior("infectious_seed", [30.0, 300.0]),
    # Detection
    UniformPrior("testing_to_detection.assumed_cdr_parameter", [0.01, 0.06]),
    # Microdistancing
    UniformPrior("mobility.microdistancing.behaviour.parameters.upper_asymptote", [0.05, 0.4]),
    # Health system-related
    UniformPrior("clinical_stratification.props.hospital.multiplier", [0.7, 1.25]),
    UniformPrior("clinical_stratification.icu_prop", [0.18, 0.25]),
