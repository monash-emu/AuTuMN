...
icu_occupancy_ts = ts_set.get("icu_occupancy").moving_average(window=7).downsample(step=7)
infection_deaths_ts = ts_set.get("infection_deaths").moving_average(window=7).downsample(step=7)
hospital_occupancy_ts = ts_set.get("hospital_occupancy").moving_average(window=7).downsample(step=7)
