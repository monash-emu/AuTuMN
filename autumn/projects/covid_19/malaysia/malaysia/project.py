...
priors = [
    ...
    *get_dispersion_priors_for_gaussian_targets(targets),
    ...
    UniformPrior("infectious_seed", [100.0, 300.0]),
    # Detection
    UniformPrior("testing_to_detection.assumed_cdr_parameter", [0.005, 0.05]),
    UniformPrior("infection_fatality.multiplier", [1.75, 3.5]),
    UniformPrior("clinical_stratification.icu_prop", [0.13, 0.17]),
    UniformPrior("mobility.microdistancing.behaviour.parameters.upper_asymptote", [0.095, 0.12]),
    ...
    UniformPrior("voc_emergence.alpha_beta.start_time", [315, 355]),
    UniformPrior("voc_emergence.delta.start_time", [446, 456]),
]
