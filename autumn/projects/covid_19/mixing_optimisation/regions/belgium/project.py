...
targets = [
    ...
    TruncNormalTarget(
        timeseries=ts_set.get("new_hospital_admissions").truncate_times(*calib_times),
        trunc_range=[0, np.inf],
    ),
    TruncNormalTarget(
...
project = Project(
    Region.BELGIUM, Models.COVID_19, build_model, param_set, calibration, plots=plot_spec
)
