...
from autumn.coreroject import Project, ParameterSet, load_timeseries, build_rel_path
...
project = Project(
    Region.FRANCE, Models.COVID_19, build_model, param_set, calibration, plots=plot_spec
)
