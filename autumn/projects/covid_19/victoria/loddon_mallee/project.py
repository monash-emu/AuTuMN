...
priors += [UniformPrior("vic_2021_seeding.seed_time", (585, 600), jumping_stdev=4)]
...
project = Project(Region.LODDON_MALLEE, Models.COVID_19, build_model, param_set, calibration, plots=plot_spec)
