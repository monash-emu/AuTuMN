...
calibration = Calibration(
    priors=priors, targets=targets, random_process=rp, metropolis_init="current_params", haario_scaling_factor=1., fixed_proposal_steps=500, metropolis_init_rel_step_size=.02
)
