...
variant_times = variant_start_time(["delta", "omicron"], "china")
priors = get_WPRO_priors(variant_times)

targets = get_tartgets(calibration_start_time, "china", "china")
...
project = Project(
    Region.WPRO_CHINA, Models.SM_SIR, build_model, param_set, calibration, plots=plot_spec
)
