...
variant_times = variant_start_time(["delta", "omicron"], "south-korea")
priors = get_WPRO_priors(variant_times)

targets = get_tartgets(calibration_start_time, "south-korea", "south-korea")
...
project = Project(
    Region.WPRO_SOUTH_KOREA, Models.SM_SIR, build_model, param_set, calibration, plots=plot_spec
)
