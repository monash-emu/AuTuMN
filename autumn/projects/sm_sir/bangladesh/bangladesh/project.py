...
baseline_params = base_params.update(build_rel_path("params/baseline.yml")).update(
    build_rel_path("params/mle-params.yml"),
...
hospital_admit_early_ts = ts_set["hospital_admissions"].loc[
    targets_start:hospital_floor_start
]
...
targets = [
    ...
    TruncNormalTarget(hospital_admit_late_ts, trunc_range=(20.0, 1e7)),
...
priors = [
    ...
    UniformPrior("voc_emergence.omicron.new_voc_seed.start_time", (580.0, 680.0)),
