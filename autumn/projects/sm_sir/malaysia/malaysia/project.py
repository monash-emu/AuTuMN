...
priors = [
    ...
    UniformPrior("sojourns.latent.total_time", (3.0, 7.5)),
    ...
    UniformPrior("voc_emergence.omicron.new_voc_seed.start_time", (580, 650)),
    ...
    UniformPrior("sojourns.recovered", (150, 400)),
