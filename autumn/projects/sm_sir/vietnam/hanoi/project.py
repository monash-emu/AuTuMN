...
priors = [
    ...
    UniformPrior("infectious_seed", (1000., 50000.)),
    ...
    UniformPrior("immunity_stratification.prop_immune", (0.5, 1.0)),
    UniformPrior("immunity_stratification.prop_high_among_immune", (0.5, 1.0)),
    # age stratification
    ...
    UniformPrior("voc_emergence.omicron.relative_active_period", (0.2, 1.0)),
