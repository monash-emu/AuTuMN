...
priors = [
    ...
    UniformPrior("voc_emergence.omicron.icu_multiplier", (0.05, 0.5)),
    UniformPrior("voc_emergence.omicron.relative_active_period", (1.0, 2.3)),
    ...
    UniformPrior("voc_emergence.wild_type.relative_latency", (0.5, 1.5)),
    # sojourns
