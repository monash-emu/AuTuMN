...
def get_epi_params(mcmc_params, strings_to_ignore=("dispersion_param", "ifr_multiplier")):
    """
...
def plot_multiple_posteriors(
    ...
    for i in range(n_rows * n_cols):
        ...
        if i < len(parameters):
            ...
            elif param_name == "history.natural_immunity_duration":
                axis.set_title("natural immunity duration", fontsize=title_font_size)
