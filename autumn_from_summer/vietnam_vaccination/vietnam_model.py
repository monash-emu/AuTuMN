...
my_parameters = {
                 ...
                 "case_detection_rate":  0.57,   # proportion of cases notified to WHO divided by number of estimated cases for that year
...
if cdr:
    ...
    treatment_rate = case_detection * (self_recovery_rate + tb_mortality_rate + universal_death_rate) / (1. - case_detection)
...
# 'detailed' gives plots of distribution by stata,
#       prevalence of each compartment for each stratification, e.g. prevalence of age 0-5 who are infectious
