...
my_parameters = {'infection_rate': 6.6,
                 'immune_stabilisation_rate': 0.001,
                 'reactivation_rate': 0.21,
                 'reinfection_from_late_latent': 0.21,
...
pp = PostProcessing(my_model, requested_outputs=['prevXsusceptibleXamong', 'prevXearly_latentXamong','prevXlate_latentXamong','prevXactive_TBXamong'])
out = Outputs([pp])
