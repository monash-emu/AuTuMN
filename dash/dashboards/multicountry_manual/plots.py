...
from autumn.plots.model.plots import _plot_outputs_to_axis, _plot_targets_to_axis
from dash.dashboards.model_results.plots import model_output_selector
PLOT_FUNCS = {}


def multi_country_manual(
    plotter, scenarios, targets, app_name, region_names
):
