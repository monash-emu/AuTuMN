...
for period in periods:
    ...
    output_path = os.path.join(
        INPUT_DATA_PATH, "social-mixing", "comix_data", "GBR", filename
    )
    ...
    pd.DataFrame(m, index=formated_agegroups).to_csv(
        output_path, header=formated_agegroups
    )
