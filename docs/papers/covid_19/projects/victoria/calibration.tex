...
The infection fatality rate (risk of death given infection) is considered a more stable quantity than the case fatality rate. However, it is still likely to vary considerably between settings and so is included as a calibration parameter which adjusts each age-specific IFR by the same value. Because the epidemic in Victoria has been characterised by high rates of transmission and disease in aged care, at baseline we assign a prior centred at a value greater than one.
