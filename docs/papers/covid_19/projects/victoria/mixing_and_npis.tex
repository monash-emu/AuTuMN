...
%\begin{figure}[H]
%    \resizebox{1\textwidth}{!}{\includegraphics[scale=1]{Images/vic_images/physical_distancing_fig.png}}
%    \caption{\textbf{Physical distancing micro-distancing function (for all clusters) with data used for fitting.}}
%    \label{fig:physical}
%\end{figure}
...
%\begin{figure}[H]
%    \resizebox{1\textwidth}{!}{\includegraphics[scale=1]{Images/vic_images/face_covering_fig.png}}
