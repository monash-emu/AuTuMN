...
where $\mathcal{I}$ is the set of infectious compartments, $\mathcal{C}$ represents all clinical strata and $\mathcal{D} \subset \mathcal{C}$ is the list of detected clinical strata.
