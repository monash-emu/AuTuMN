...
For this reason we introduced a universal indicator named ``hospital occupancy pressure'' in our analysis. This indicator
...
The ``hospital occupancy pressure'' indicator can therefore be interpreted as the level of hospital occupancy that
...
We then computed the ``hospital occupancy pressure'' quantity $h$, which is an indicator of hospital occupancy level, by combining the number of new 
