...
locations: home, school, work, other locations. In a Sensitivity Analysis, we repeated our estimations using alternative contact matrices provided by Mistry et al. 
for the 25 countries in our study where these matrices were available \cite{mistry2021}. The results associated with these 
additional analyses are presented in Section \ref{SA_mistry}.
...
attending school. We assumed that between 10 and 50\% of students attended on-site learning during these periods.
