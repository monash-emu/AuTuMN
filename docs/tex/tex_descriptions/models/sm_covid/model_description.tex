...
The main rationale for using multiple serial compartments for both the exposed and active states is to achieve an Erlang distribution for the time spent in each of these states. This distribution is more realistic than
...
In a Sensitivity Analysis, we explored the impact of using alternative model structures on our main findings. Namely,
we repeated the analyses for the three countries highlighted in the main text (Morocco, the UK and Indonesia), this time 
considering different numbers of serial compartments to capture both incubation and active disease periods. See results in 
Section \ref{SA_erlang}. 
...
\label{mixing}
\input{../../tex_descriptions/models/sm_covid/mixing.tex} 
