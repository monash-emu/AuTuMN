...
\begin{itemize}
    \item Susceptible
    \begin{itemize}
        \item Persons not previously infected with SARS-CoV-2 during or before the model simulation period
    \end{itemize}
    \item Latent
    \begin{itemize}
...
The four active disease compartments all have identical characteristics. However, the last two latent compartments ($E^3$ and $E^4$) are infectious whereas the first two ($E^1$ and $E^2$) are not. We further assume that 
