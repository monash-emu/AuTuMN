...
disease
\begin{figure}[!htb]
    \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{cbr.png}
    \caption{The crude birth rate of Kiribati from 1950 to 2020.}
    \label{fig:cbr}
\end{figure}

\begin{figure}[!htb]
    \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{cdr.png}
...
\begin{figure}[!htb]
    \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{modelled_total.png}
...
\begin{figure}[!htb]
    \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{compare_pop.png}
