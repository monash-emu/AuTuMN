...
In addition, for countries where a nationally representative seroprevalence survey had been conducted (n=36), we include
...
Seroprevalence estimates had to verify the following conditions to be included in the analysis as calibration targets:
\begin{itemize}
...
Where a seroprevalence study was restricted to a specific age-group, we matched the survey estimate to the modelled seroprevalence measured in the 
