            ...
            for i in numpy.arange(0, len(x_vals), 1):
                ...
                for a, b in enumerate(model.var_labels):
                    if b == 'births_vac':
                        ...
                        cost_predefined = cost_uninflated
...
#######################################################################################
            ...
            indexes = numpy.arange(12001, 14002, 1)
            replacements = numpy.linspace(2000, 3000, 2001)
...
#######################################################################################
            ...
            indexes = numpy.arange(12001, 14002, 1)
            replacements = numpy.linspace(20000, 30000, 2001)
...
#######################################################################################
            ...
            indexes = numpy.arange(11001, 14002, 1)
            replacements = numpy.linspace(50000, 80000, 3001)
    ...
    plt.plot(x_vals, coverage_new_ipt)
    plt.show()
    '''
