...
def economics_diagnostic(model, period_end,
    ...
    c_reflection_cost_base ='econ_program_reflectioncost_'
    ...
    for intervention in interventions: # for each intervention
        ...
        c_reflection_cost_label = c_reflection_cost_base + intervention # key of the scale up function for reflection cost
        c_reflection_cost_function = model.scaleup_fns[c_reflection_cost_label]
        ...
        pop_size_index = model.var_labels.index(popsize_label) # column index in model.var_array that corresponds to the intervention
