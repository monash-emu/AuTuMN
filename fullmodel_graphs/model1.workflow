digraph {
	...
	edge [arrowhead=open fontname=Courier fontsize=10 style=dotted]
		...
		tb_death
			...
			latent_early_xdr_nocomorbs -> active_smearpos_xdr_nocomorbs [label=0.30]
			latent_late_xdr_nocomorbs -> active_smearpos_xdr_nocomorbs [label=0.0070]
			...
			latent_early_ds_hiv -> active_smearpos_ds_hiv [label=0.30]
			latent_late_ds_hiv -> active_smearpos_ds_hiv [label=0.0070]
			...
			latent_early_mdr_hiv -> active_smearpos_mdr_hiv [label=0.30]
			latent_late_mdr_hiv -> active_smearpos_mdr_hiv [label=0.0070]
			...
			latent_early_xdr_hiv -> active_smearpos_xdr_hiv [label=0.30]
			latent_late_xdr_hiv -> active_smearpos_xdr_hiv [label=0.0070]
			...
			latent_early_ds_diabetes -> active_smearpos_ds_diabetes [label=0.30]
			latent_late_ds_diabetes -> active_smearpos_ds_diabetes [label=0.0070]
			...
			latent_early_mdr_diabetes -> active_smearpos_mdr_diabetes [label=0.30]
			latent_late_mdr_diabetes -> active_smearpos_mdr_diabetes [label=0.0070]
			...
			latent_early_xdr_diabetes -> active_smearpos_xdr_diabetes [label=0.30]
			latent_late_xdr_diabetes -> active_smearpos_xdr_diabetes [label=0.0070]
