digraph {
	...
	edge [arrowhead=open fontname=Courier fontsize=10 style=dotted]
		...
		lowquality_smearpos_ds_diabetes
		lowquality_smearneg_ds_diabetes
		lowquality_smearpos_mdr_diabetes
		lowquality_smearneg_mdr_diabetes
		tb_death
			...
			active_smearpos_ds_nocomorbs -> lowquality_smearpos_ds_nocomorbs [label=program_rate_enterlowquality]
			active_smearpos_ds_hiv -> missed_smearpos_ds_hiv [label=program_rate_missed]
			active_smearpos_ds_hiv -> lowquality_smearpos_ds_hiv [label=program_rate_enterlowquality]
			active_smearpos_ds_diabetes -> missed_smearpos_ds_diabetes [label=program_rate_missed]
			active_smearpos_ds_diabetes -> lowquality_smearpos_ds_diabetes [label=program_rate_enterlowquality]
			active_smearneg_ds_nocomorbs -> missed_smearneg_ds_nocomorbs [label=program_rate_missed]
			active_smearneg_ds_nocomorbs -> lowquality_smearneg_ds_nocomorbs [label=program_rate_enterlowquality]
			active_smearneg_ds_hiv -> missed_smearneg_ds_hiv [label=program_rate_missed]
			active_smearneg_ds_hiv -> lowquality_smearneg_ds_hiv [label=program_rate_enterlowquality]
			active_smearneg_ds_diabetes -> missed_smearneg_ds_diabetes [label=program_rate_missed]
			active_smearneg_ds_diabetes -> lowquality_smearneg_ds_diabetes [label=program_rate_enterlowquality]
			active_smearpos_mdr_nocomorbs -> missed_smearpos_mdr_nocomorbs [label=program_rate_missed]
			active_smearpos_mdr_nocomorbs -> lowquality_smearpos_mdr_nocomorbs [label=program_rate_enterlowquality]
			active_smearpos_mdr_hiv -> missed_smearpos_mdr_hiv [label=program_rate_missed]
			active_smearpos_mdr_hiv -> lowquality_smearpos_mdr_hiv [label=program_rate_enterlowquality]
			active_smearpos_mdr_diabetes -> missed_smearpos_mdr_diabetes [label=program_rate_missed]
			active_smearpos_mdr_diabetes -> lowquality_smearpos_mdr_diabetes [label=program_rate_enterlowquality]
			active_smearneg_mdr_nocomorbs -> missed_smearneg_mdr_nocomorbs [label=program_rate_missed]
			active_smearneg_mdr_nocomorbs -> lowquality_smearneg_mdr_nocomorbs [label=program_rate_enterlowquality]
			active_smearneg_mdr_hiv -> missed_smearneg_mdr_hiv [label=program_rate_missed]
			active_smearneg_mdr_hiv -> lowquality_smearneg_mdr_hiv [label=program_rate_enterlowquality]
			active_smearneg_mdr_diabetes -> missed_smearneg_mdr_diabetes [label=program_rate_missed]
			active_smearneg_mdr_diabetes -> lowquality_smearneg_mdr_diabetes [label=program_rate_enterlowquality]
			...
			lowquality_smearpos_ds_nocomorbs -> latent_late_ds_nocomorbs [label=0.10]
			...
			lowquality_smearpos_mdr_nocomorbs -> latent_late_mdr_nocomorbs [label=0.10]
			...
			lowquality_smearpos_ds_hiv -> latent_late_ds_hiv [label=0.10]
			...
			lowquality_smearpos_mdr_hiv -> latent_late_mdr_hiv [label=0.10]
			...
			lowquality_smearpos_ds_diabetes -> latent_late_ds_diabetes [label=0.10]
			...
			lowquality_smearneg_ds_diabetes -> latent_late_ds_diabetes [label=0.27]
			...
			lowquality_smearpos_mdr_diabetes -> latent_late_mdr_diabetes [label=0.10]
			...
			lowquality_smearneg_mdr_diabetes -> latent_late_mdr_diabetes [label=0.27]
			...
			lowquality_smearpos_ds_nocomorbs -> active_smearpos_ds_nocomorbs [label=2.0]
			...
			lowquality_smearpos_ds_hiv -> active_smearpos_ds_hiv [label=2.0]
			detect_smearpos_ds_hiv -> treatment_infect_smearpos_ds_hiv [label=26.0]
			missed_smearpos_ds_diabetes -> active_smearpos_ds_diabetes [label=4.0]
			lowquality_smearpos_ds_diabetes -> active_smearpos_ds_diabetes [label=2.0]
			detect_smearpos_ds_diabetes -> treatment_infect_smearpos_ds_diabetes [label=26.0]
			missed_smearneg_ds_nocomorbs -> active_smearneg_ds_nocomorbs [label=4.0]
			lowquality_smearneg_ds_nocomorbs -> active_smearneg_ds_nocomorbs [label=2.0]
			...
			lowquality_smearneg_ds_hiv -> active_smearneg_ds_hiv [label=2.0]
			detect_smearneg_ds_hiv -> treatment_infect_smearneg_ds_hiv [label=26.0]
			missed_smearneg_ds_diabetes -> active_smearneg_ds_diabetes [label=4.0]
			lowquality_smearneg_ds_diabetes -> active_smearneg_ds_diabetes [label=2.0]
			detect_smearneg_ds_diabetes -> treatment_infect_smearneg_ds_diabetes [label=26.0]
			missed_smearpos_mdr_nocomorbs -> active_smearpos_mdr_nocomorbs [label=4.0]
			lowquality_smearpos_mdr_nocomorbs -> active_smearpos_mdr_nocomorbs [label=2.0]
			...
			lowquality_smearpos_mdr_hiv -> active_smearpos_mdr_hiv [label=2.0]
			detect_smearpos_mdr_hiv -> treatment_infect_smearpos_mdr_hiv [label=26.0]
			missed_smearpos_mdr_diabetes -> active_smearpos_mdr_diabetes [label=4.0]
			lowquality_smearpos_mdr_diabetes -> active_smearpos_mdr_diabetes [label=2.0]
			detect_smearpos_mdr_diabetes -> treatment_infect_smearpos_mdr_diabetes [label=26.0]
			missed_smearneg_mdr_nocomorbs -> active_smearneg_mdr_nocomorbs [label=4.0]
			lowquality_smearneg_mdr_nocomorbs -> active_smearneg_mdr_nocomorbs [label=2.0]
			...
			lowquality_smearneg_mdr_hiv -> active_smearneg_mdr_hiv [label=2.0]
			detect_smearneg_mdr_hiv -> treatment_infect_smearneg_mdr_hiv [label=26.0]
			missed_smearneg_mdr_diabetes -> active_smearneg_mdr_diabetes [label=4.0]
			lowquality_smearneg_mdr_diabetes -> active_smearneg_mdr_diabetes [label=2.0]
			detect_smearneg_mdr_diabetes -> treatment_infect_smearneg_mdr_diabetes [label=26.0]
			...
			lowquality_smearpos_ds_nocomorbs -> tb_death [label=0.23]
			...
			lowquality_smearpos_mdr_nocomorbs -> tb_death [label=0.23]
			...
			lowquality_smearpos_ds_hiv -> tb_death [label=0.23]
			...
			lowquality_smearpos_mdr_hiv -> tb_death [label=0.23]
			...
			lowquality_smearpos_ds_diabetes -> tb_death [label=0.23]
			...
			lowquality_smearneg_ds_diabetes -> tb_death [label=0.07]
			...
			lowquality_smearpos_mdr_diabetes -> tb_death [label=0.23]
			...
			lowquality_smearneg_mdr_diabetes -> tb_death [label=0.07]
