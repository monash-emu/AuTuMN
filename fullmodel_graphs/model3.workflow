digraph {
	...
	edge [arrowhead=open fontname=Courier fontsize=10 style=dotted]
		...
		tb_death
			...
			detect_smearpos -> treatment_infect_smearpos [label=prog]
			active_smearneg -> missed_smearneg [label=prog]
			detect_smearneg -> treatment_infect_smearneg [label=prog]
			active_extrapul -> missed_extrapul [label=prog]
			detect_extrapul -> treatment_infect_extrapul [label=prog]
