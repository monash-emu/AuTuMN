digraph {
	...
	edge [arrowhead=open fontname=Courier fontsize=10 style=dotted]
		...
		tb_death
			...
			active_extrapul_ds_diabetes -> missed_extrapul_ds_diabetes [label=program_rate_missed]
			...
			active_extrapul_mdr_diabetes -> missed_extrapul_mdr_diabetes [label=program_rate_missed]
			...
			active_extrapul_xdr_nocomorbs -> missed_extrapul_xdr_nocomorbs [label=program_rate_missed]
			active_extrapul_xdr_hiv -> missed_extrapul_xdr_hiv [label=program_rate_missed]
			active_extrapul_xdr_diabetes -> missed_extrapul_xdr_diabetes [label=program_rate_missed]
			...
			active_extrapul_xdr_nocomorbs -> detect_extrapul_xdr_nocomorbs [label=program_rate_detect]
			active_extrapul_ds_hiv -> detect_extrapul_ds_hiv [label=program_rate_detect]
			active_extrapul_mdr_hiv -> detect_extrapul_mdr_hiv [label=program_rate_detect]
			active_extrapul_xdr_hiv -> detect_extrapul_xdr_hiv [label=program_rate_detect]
			active_extrapul_ds_diabetes -> detect_extrapul_ds_diabetes [label=program_rate_detect]
			active_extrapul_mdr_diabetes -> detect_extrapul_mdr_diabetes [label=program_rate_detect]
			active_extrapul_xdr_diabetes -> detect_extrapul_xdr_diabetes [label=program_rate_detect]
			...
			detect_extrapul_ds_nocomorbs -> latent_late_ds_nocomorbs [label=0.27]
			...
			detect_extrapul_mdr_nocomorbs -> latent_late_mdr_nocomorbs [label=0.27]
			...
			latent_early_xdr_nocomorbs -> active_smearneg_xdr_nocomorbs [label=0.17]
			latent_late_xdr_nocomorbs -> active_smearneg_xdr_nocomorbs [label=0.0040]
			...
			latent_early_xdr_nocomorbs -> active_extrapul_xdr_nocomorbs [label=0.0051]
			latent_late_xdr_nocomorbs -> active_extrapul_xdr_nocomorbs [label=0.000120]
			active_extrapul_xdr_nocomorbs -> latent_late_xdr_nocomorbs [label=0.27]
			missed_extrapul_xdr_nocomorbs -> latent_late_xdr_nocomorbs [label=0.27]
			detect_extrapul_xdr_nocomorbs -> latent_late_xdr_nocomorbs [label=0.27]
			...
			detect_extrapul_ds_hiv -> latent_late_ds_hiv [label=0.27]
			...
			detect_extrapul_mdr_hiv -> latent_late_mdr_hiv [label=0.27]
			...
			latent_early_xdr_hiv -> active_smearneg_xdr_hiv [label=0.17]
			latent_late_xdr_hiv -> active_smearneg_xdr_hiv [label=0.0040]
			...
			latent_early_xdr_hiv -> active_extrapul_xdr_hiv [label=0.0051]
			latent_late_xdr_hiv -> active_extrapul_xdr_hiv [label=0.000120]
			active_extrapul_xdr_hiv -> latent_late_xdr_hiv [label=0.27]
			missed_extrapul_xdr_hiv -> latent_late_xdr_hiv [label=0.27]
			detect_extrapul_xdr_hiv -> latent_late_xdr_hiv [label=0.27]
			...
			latent_early_ds_diabetes -> active_smearneg_ds_diabetes [label=0.17]
			latent_late_ds_diabetes -> active_smearneg_ds_diabetes [label=0.0040]
			...
			latent_early_ds_diabetes -> active_extrapul_ds_diabetes [label=0.0051]
			latent_late_ds_diabetes -> active_extrapul_ds_diabetes [label=0.000120]
			active_extrapul_ds_diabetes -> latent_late_ds_diabetes [label=0.27]
			missed_extrapul_ds_diabetes -> latent_late_ds_diabetes [label=0.27]
			detect_extrapul_ds_diabetes -> latent_late_ds_diabetes [label=0.27]
			...
			latent_early_mdr_diabetes -> active_smearneg_mdr_diabetes [label=0.17]
			latent_late_mdr_diabetes -> active_smearneg_mdr_diabetes [label=0.0040]
			...
			latent_early_mdr_diabetes -> active_extrapul_mdr_diabetes [label=0.0051]
			latent_late_mdr_diabetes -> active_extrapul_mdr_diabetes [label=0.000120]
			active_extrapul_mdr_diabetes -> latent_late_mdr_diabetes [label=0.27]
			missed_extrapul_mdr_diabetes -> latent_late_mdr_diabetes [label=0.27]
			detect_extrapul_mdr_diabetes -> latent_late_mdr_diabetes [label=0.27]
			...
			latent_early_xdr_diabetes -> active_smearneg_xdr_diabetes [label=0.17]
			latent_late_xdr_diabetes -> active_smearneg_xdr_diabetes [label=0.0040]
			...
			latent_early_xdr_diabetes -> active_extrapul_xdr_diabetes [label=0.0051]
			latent_late_xdr_diabetes -> active_extrapul_xdr_diabetes [label=0.000120]
			active_extrapul_xdr_diabetes -> latent_late_xdr_diabetes [label=0.27]
			missed_extrapul_xdr_diabetes -> latent_late_xdr_diabetes [label=0.27]
			detect_extrapul_xdr_diabetes -> latent_late_xdr_diabetes [label=0.27]
			...
			missed_extrapul_ds_diabetes -> active_extrapul_ds_diabetes [label=4.0]
			...
			missed_extrapul_mdr_diabetes -> active_extrapul_mdr_diabetes [label=4.0]
			...
			missed_extrapul_xdr_nocomorbs -> active_extrapul_xdr_nocomorbs [label=4.0]
			missed_extrapul_xdr_hiv -> active_extrapul_xdr_hiv [label=4.0]
			missed_extrapul_xdr_diabetes -> active_extrapul_xdr_diabetes [label=4.0]
			...
			treatment_infect_extrapul_xdr_nocomorbs -> treatment_noninfect_extrapul_xdr_nocomorbs [label=5.8]
			treatment_noninfect_extrapul_xdr_nocomorbs -> susceptible_treated_nocomorbs [label=0.16]
			treatment_infect_extrapul_xdr_nocomorbs -> active_extrapul_xdr_nocomorbs [label=0.20]
			treatment_noninfect_extrapul_xdr_nocomorbs -> active_extrapul_xdr_nocomorbs [label=0.15]
			...
			treatment_infect_extrapul_ds_hiv -> treatment_noninfect_extrapul_ds_hiv [label=28.4]
			treatment_noninfect_extrapul_ds_hiv -> susceptible_treated_hiv [label=2.0]
			treatment_infect_extrapul_ds_hiv -> active_extrapul_ds_hiv [label=0.16]
			treatment_noninfect_extrapul_ds_hiv -> active_extrapul_ds_hiv [label=0.15]
			...
			treatment_infect_extrapul_mdr_hiv -> treatment_noninfect_extrapul_mdr_hiv [label=11.8]
			treatment_noninfect_extrapul_mdr_hiv -> susceptible_treated_hiv [label=0.32]
			treatment_infect_extrapul_mdr_hiv -> active_extrapul_mdr_hiv [label=0.18]
			treatment_noninfect_extrapul_mdr_hiv -> active_extrapul_mdr_hiv [label=0.15]
			...
			treatment_infect_extrapul_xdr_hiv -> treatment_noninfect_extrapul_xdr_hiv [label=5.8]
			treatment_noninfect_extrapul_xdr_hiv -> susceptible_treated_hiv [label=0.16]
			treatment_infect_extrapul_xdr_hiv -> active_extrapul_xdr_hiv [label=0.20]
			treatment_noninfect_extrapul_xdr_hiv -> active_extrapul_xdr_hiv [label=0.15]
			...
			treatment_infect_extrapul_ds_diabetes -> treatment_noninfect_extrapul_ds_diabetes [label=28.4]
			treatment_noninfect_extrapul_ds_diabetes -> susceptible_treated_diabetes [label=2.0]
			treatment_infect_extrapul_ds_diabetes -> active_extrapul_ds_diabetes [label=0.16]
			treatment_noninfect_extrapul_ds_diabetes -> active_extrapul_ds_diabetes [label=0.15]
			...
			treatment_infect_extrapul_mdr_diabetes -> treatment_noninfect_extrapul_mdr_diabetes [label=11.8]
			treatment_noninfect_extrapul_mdr_diabetes -> susceptible_treated_diabetes [label=0.32]
			treatment_infect_extrapul_mdr_diabetes -> active_extrapul_mdr_diabetes [label=0.18]
			treatment_noninfect_extrapul_mdr_diabetes -> active_extrapul_mdr_diabetes [label=0.15]
			...
			treatment_infect_extrapul_xdr_diabetes -> treatment_noninfect_extrapul_xdr_diabetes [label=5.8]
			treatment_noninfect_extrapul_xdr_diabetes -> susceptible_treated_diabetes [label=0.16]
			treatment_infect_extrapul_xdr_diabetes -> active_extrapul_xdr_diabetes [label=0.20]
			treatment_noninfect_extrapul_xdr_diabetes -> active_extrapul_xdr_diabetes [label=0.15]
			...
			detect_extrapul_mdr_nocomorbs -> tb_death [label=0.07]
			...
			active_extrapul_xdr_nocomorbs -> tb_death [label=0.07]
			missed_extrapul_xdr_nocomorbs -> tb_death [label=0.07]
			detect_extrapul_xdr_nocomorbs -> tb_death [label=0.07]
			...
			detect_extrapul_ds_hiv -> tb_death [label=0.07]
			...
			detect_extrapul_mdr_hiv -> tb_death [label=0.07]
			...
			active_extrapul_xdr_hiv -> tb_death [label=0.07]
			missed_extrapul_xdr_hiv -> tb_death [label=0.07]
			detect_extrapul_xdr_hiv -> tb_death [label=0.07]
			...
			active_extrapul_ds_diabetes -> tb_death [label=0.07]
			missed_extrapul_ds_diabetes -> tb_death [label=0.07]
			detect_extrapul_ds_diabetes -> tb_death [label=0.07]
			...
			active_extrapul_mdr_diabetes -> tb_death [label=0.07]
			missed_extrapul_mdr_diabetes -> tb_death [label=0.07]
			detect_extrapul_mdr_diabetes -> tb_death [label=0.07]
			...
			active_extrapul_xdr_diabetes -> tb_death [label=0.07]
			missed_extrapul_xdr_diabetes -> tb_death [label=0.07]
			detect_extrapul_xdr_diabetes -> tb_death [label=0.07]
			...
			treatment_infect_extrapul_xdr_nocomorbs -> tb_death [label=0.05]
			treatment_noninfect_extrapul_xdr_nocomorbs -> tb_death [label=0.0498]
			...
			treatment_infect_extrapul_ds_hiv -> tb_death [label=0.05]
			treatment_noninfect_extrapul_ds_hiv -> tb_death [label=0.0500]
			...
			treatment_infect_extrapul_mdr_hiv -> tb_death [label=0.05]
			treatment_noninfect_extrapul_mdr_hiv -> tb_death [label=0.0499]
			...
			treatment_infect_extrapul_xdr_hiv -> tb_death [label=0.05]
			treatment_noninfect_extrapul_xdr_hiv -> tb_death [label=0.0498]
			...
			treatment_infect_extrapul_ds_diabetes -> tb_death [label=0.05]
			treatment_noninfect_extrapul_ds_diabetes -> tb_death [label=0.0500]
			...
			treatment_infect_extrapul_mdr_diabetes -> tb_death [label=0.05]
			treatment_noninfect_extrapul_mdr_diabetes -> tb_death [label=0.0499]
			...
			treatment_infect_extrapul_xdr_diabetes -> tb_death [label=0.05]
			treatment_noninfect_extrapul_xdr_diabetes -> tb_death [label=0.0498]
}