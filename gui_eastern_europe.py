...
class App:
    ...
    def __init__(self, master):
        ...
        self.boolean_dictionary['riskgroup_prison'].set(False)
        # self.boolean_dictionary['riskgroup_urbanpoor'].set(True)
        self.boolean_dictionary['riskgroup_ruralpoor'].set(False)
        self.boolean_dictionary['output_gtb_plots'].set(True)
        self.boolean_dictionary['is_vary_force_infection_by_riskgroup'].set(False)
    ...
    def run_model(self):
        ...
        model_runner = autumn.model_runner.TbRunner(self.gui_outputs, self.runtime_outputs, self.figure_frame)
