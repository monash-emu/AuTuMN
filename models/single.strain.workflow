digraph {
	...
	edge [arrowhead=open fontname=Courier fontsize=10 style=dotted]
		...
		tb_death
			...
			latent_early -> active [label=0.2]
			latent_early -> latent_late [label=1.8]
			latent_late -> active [label=0.001]
			active -> latent_late [label=0.2]
			active -> treatment_infect [label=1.0]
			treatment_infect -> treatment_noninfect [label=1.8]
			treatment_infect -> active [label=0.1]
			treatment_noninfect -> susceptible [label=1.8]
			treatment_noninfect -> active [label=0.1]
			active -> tb_death [label=0.133333333333]
			treatment_infect -> tb_death [label=0.1]
			treatment_noninfect -> tb_death [label=0.1]
}